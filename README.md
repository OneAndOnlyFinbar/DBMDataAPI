...
Once you have downloaded the main branch drag and drop the `DBM_DataApi.js` file over to your bots main directory. Then install [the express node module](https://www.npmjs.com/package/express).

# Running

Once installed properly run `node DBM_DataApi.js` to start the api.
